package com.hsk4dictionary.support.opensource.retrofit;

import com.hsk4dictionary.support.opensource.retrofit.apis.HSK4Dictionary;
...
/**
 * Originated from http://tiii.tistory.com/11
 */
public class RestfulAdapter {
    public static final int CONNECT_TIMEOUT = 15;
    public static final int WRITE_TIMEOUT = 15;
    public static final int READ_TIMEOUT = 15;
    private static final String SERVER_URL = "https://hsk-4-dictionary-pjhjohn.c9users.io/"; //2부터 url뒤에 /를 입력해야 합니다.
    private static OkHttpClient client;
    private static HSK4Dictionary Interface;

    public synchronized static HSK4Dictionary getInstance() {
        if (Interface == null) {
            //통신로그를 확인하기 위한 부분
            ...
            Interface = new Retrofit.Builder()
                ...
                .build().create(HSK4Dictionary.class); //인터페이스 연결
        }
        return Interface;
    }
